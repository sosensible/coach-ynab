...
<template>
  <div class="rounded overflow-hidden shadow-lg flex flex-col" v-for="article in articles" key="article.id">
    <a href="#"></a>
    <div class="relative"><a href="#">
        <img class="w-full" :src="article.image" alt="To be added to data">
        <div
