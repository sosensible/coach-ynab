...
<template>
  <div class="rounded overflow-hidden shadow-lg flex flex-col" v-for="mediaItem in media" key="mediaItem.id">
    <a href="#"></a>
    <div class="relative"><a href="#">
        <img class="w-full" :src="mediaItem.image" alt="To be added to data">
        <div
    ...
    <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
      <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
        ...
        <span class="ml-1">{{ mediaItem.date }}</span>
      </span>
      <!-- 
      <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
